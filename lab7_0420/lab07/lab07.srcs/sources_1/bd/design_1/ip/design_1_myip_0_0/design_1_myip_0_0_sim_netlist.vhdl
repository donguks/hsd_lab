...
-- Date        : Fri Apr 20 15:49:43 2018
-- Host        : 310-2-02 running 64-bit Ubuntu 16.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /csehome/sdu6342/hsd/lab7_0420/lab07/lab07.srcs/sources_1/bd/design_1/ip/design_1_myip_0_0/design_1_myip_0_0_sim_netlist.vhdl
...
entity design_1_myip_0_0_myip_v1_0_S00_AXI is
  port (
    m00_bram_we : out STD_LOGIC_VECTOR ( 0 to 0 );
    S_AXI_ARREADY : out STD_LOGIC;
    m00_bram_clk : out STD_LOGIC;
    \m00_bram_addr[3]\ : out STD_LOGIC;
    \m00_bram_addr[2]\ : out STD_LOGIC;
...
architecture STRUCTURE of design_1_myip_0_0_myip_v1_0_S00_AXI is
  ...
  signal bram_state : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \bram_state[0]_i_1_n_0\ : STD_LOGIC;
  signal \bram_state[0]_i_2_n_0\ : STD_LOGIC;
  signal \bram_state[0]_i_3_n_0\ : STD_LOGIC;
  signal \bram_state[0]_i_4_n_0\ : STD_LOGIC;
  signal \bram_state[0]_i_5_n_0\ : STD_LOGIC;
  signal \bram_state[0]_i_6_n_0\ : STD_LOGIC;
  signal \bram_state[0]_i_7_n_0\ : STD_LOGIC;
  signal \bram_state[0]_i_8_n_0\ : STD_LOGIC;
  signal \^m00_bram_addr[2]\ : STD_LOGIC;
  signal \^m00_bram_addr[3]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \bram_counter[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \bram_counter[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \slv_reg0[31]_i_3\ : label is "soft_lutpair3";
begin
  S_AXI_ARREADY <= \^s_axi_arready\;
  S_AXI_AWREADY <= \^s_axi_awready\;
  S_AXI_WREADY <= \^s_axi_wready\;
  \m00_bram_addr[2]\ <= \^m00_bram_addr[2]\;
  \m00_bram_addr[3]\ <= \^m00_bram_addr[3]\;
...
\bram_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8080FFFFFF808080"
    )
        port map (
      I0 => \bram_state[0]_i_2_n_0\,
      I1 => \bram_state[0]_i_3_n_0\,
      I2 => \bram_state[0]_i_4_n_0\,
      I3 => \bram_state[0]_i_5_n_0\,
      I4 => bram_state(1),
      I5 => bram_state(0),
      O => \bram_state[0]_i_1_n_0\
    );
\bram_state[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => slv_reg0(25),
      I5 => slv_reg0(24),
      O => \bram_state[0]_i_2_n_0\
    );
\bram_state[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
      ...
      I4 => slv_reg0(31),
      I5 => slv_reg0(30),
      O => \bram_state[0]_i_3_n_0\
    );
\bram_state[0]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000008000000000"
    )
        port map (
      I0 => \bram_state[0]_i_6_n_0\,
      I1 => \bram_state[0]_i_7_n_0\,
      I2 => \bram_state[0]_i_8_n_0\,
      I3 => bram_state(1),
      I4 => slv_reg0(1),
      I5 => slv_reg0(0),
      O => \bram_state[0]_i_4_n_0\
    );
\bram_state[0]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
      I0 => \^m00_bram_addr[2]\,
      I1 => \^m00_bram_addr[3]\,
      O => \bram_state[0]_i_5_n_0\
    );
\bram_state[0]_i_6\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => slv_reg0(13),
      I5 => slv_reg0(12),
      O => \bram_state[0]_i_6_n_0\
    );
\bram_state[0]_i_7\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => slv_reg0(19),
      I5 => slv_reg0(18),
      O => \bram_state[0]_i_7_n_0\
    );
\bram_state[0]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000002000000000"
    )
        port map (
      ...
      I4 => slv_reg0(7),
      I5 => slv_reg0(6),
      O => \bram_state[0]_i_8_n_0\
    );
\bram_state_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
...
\bram_state_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => bram_state(0),
...
\m00_bram_we[0]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of design_1_myip_0_0 is
  ...
  signal \^m00_bram_addr\ : STD_LOGIC_VECTOR ( 3 downto 2 );
...
begin
  ...
  m00_bram_addr(4) <= \^m00_bram_we\(0);
  m00_bram_addr(3 downto 2) <= \^m00_bram_addr\(3 downto 2);
